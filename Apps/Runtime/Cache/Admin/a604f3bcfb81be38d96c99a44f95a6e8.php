                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header bg-light-blue">
                                    <img src="../../<?php echo session('E_STAFF.staffPhoto');?>" class="img-circle" alt="<?php echo session('E_STAFF.roleName');?>" />
                                    <p>
                ...
                <section class="sidebar">
                    ...
                    <div class="user-panel">
                        <div class="pull-left image">
                            <img src="../../<?php echo session('E_STAFF.staffPhoto');?>" class="img-circle" alt="<?php echo session('E_STAFF.staffName');?>" />
                        </div>

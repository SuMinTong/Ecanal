...
<html>
    <head>
        ...
        <!--[if lt IE 9]>
          <script src="/e/Public/js/html5shiv.min.js"></script>
          <script src="/e/Public/js/respond.min.js"></script>
        <![endif]-->
        ...
        <script>
	      $(function () {
	    	  $('#pageContent').height(E.pageHeight()-98);
	    	  getTask();
	      });
                ...
                <div class="navbar-right">
                    <ul class="nav navbar-nav">
                        <li class="dropdown user user-menu">
                            <!-- <a href="<?php echo EDomain();?>" target='_blank'> -->
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span><?php echo session('E_STAFF.staffName');?>&nbsp;<i class="caret"></i></span>
                            </a>
                            <ul class="dropdown-menu">
                                <!-- User image -->
                                <li class="user-header bg-light-blue">
                                    <img src="/e/<?php echo session('E_STAFF.staffPhoto');?>" class="img-circle" alt="<?php echo session('E_STAFF.roleName');?>" />
                                    <p>
                                        <?php echo session('E_STAFF.staffName');?> - <?php echo session('E_STAFF.roleName');?>
                                        <small>职员编号：<?php echo ($E_STAFF["staffNo"]); ?></small>
                                    </p>
                                </li>
                                <!-- Menu Body -->
                ...
                <section class="sidebar">
                    ...
                    <div class="user-panel">
                        <div class="pull-left image">
                            <img src="img/staff.png" class="img-circle" alt="<?php echo session('E_STAFF.staffName');?>" />
                        </div>
                        <div class="pull-left info">
                            <p>Hello, <?php echo session('E_STAFF.staffName');?></p>
                        </div>
                    </div>
                    <!-- sidebar menu: : style can be found in sidebar.less -->
                    <ul class="sidebar-menu">
                        <!-- <?php if(in_array('spgl_00',$E_STAFF['grant'])){ ?> -->
                       <!--  <li class="treeview">
                            <a href="#">
                                <span>商品管理</span>
